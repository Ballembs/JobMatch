...
<section id="list-postJob" class="first">
	...
	<table class="table table-bordered margin-top-medium">
		<thead>
			<tr>
				...
				<g:sortableColumn property="keywords" title="${message(code: 'postJob.keywords.label', default: 'Keywords')}" />
			
				<g:sortableColumn property="workExperienceMin" title="${message(code: 'postJob.workExperienceMin.label', default: 'Work Experience')}" />
		...
		<g:each in="${postJobInstanceList}" status="i" var="postJobInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td>${fieldValue(bean: postJobInstance, field: "keywords")}</td>
