...
<head>
	...
	<script type="text/javascript" src="../js/MailJs.js" ></script>
	...
	<table class="table table-bordered margin-top-medium">
		<thead>
			<tr>
				...
				<td><lable>Send mail</lable></td>				
			
			</tr>
		</thead>
		<g:set var="mailTo" value="${''}" />
		<tbody>
		<g:each in="${userProfileInstanceList}" status="i" var="userProfileInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td><g:checkBox name="mailTo" checked="false" value="${fieldValue(bean: userProfileInstance, field: "email")}"/></td>
